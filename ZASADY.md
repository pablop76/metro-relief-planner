...
**R20** ✅ **Podmiana przez przeciwny tor / przeciwny kierunek.** Gdy podmiana opiera się na trafieniu w odjazd z **przeciwnego toru** (maszynista/rezerwowy przechodzi na drugi peron i łapie pociąg w przeciwnym kierunku), zakładamy **bufor ~5 min**. Gdy okno jest ciasne → silnik pokazuje **alert ⚠ „mało czasu (~5 min) — skontaktuj się z pociągiem"**; maszynista poinformowany sam się dogada, żeby zdążyć. Alert widoczny **na przerwie w planie ORAZ na pasku bocznym „Rezerwowi na stacjach"** przy danej podmianie. Zwykłe podmiany (wraca ten sam pociąg) — bez bufora. _(D9)_
